...
# beta
beta01=6   ;beta11=-.1  # com1 - upper line 
beta02=5.5   ;beta12=-.15  # com2 - bottom line
beta03=.5   ;beta13=.2  # com3 - bottom line
...
while(i < B) {
  ...
  if(i%in%seq(50,1000,by=50)) save.image(file=paste("3s_n",n,".RData",sep=""))
  }
}
...
## save .RData
save.image(file=paste("3s_n",n,".RData",sep=""))


## save to txt files

write(paste("Time is", end_time-start_time, attr(end_time-start_time,"units")), 
      file=paste("3s_n",n,"_time",".txt",sep=""))

write.table(y.B, file=paste("3s_n",n,"_samples",".txt",sep=""), sep="  ", row.names=1:B)
write.table(y.E, file=paste("3s_n",n,"_badsamples",".txt",sep=""), sep="  ")

write.table(MLE.cmp, file=paste("3s_n",n,"_MLEs",".txt",sep=""), sep="  ", row.names=1:B)
