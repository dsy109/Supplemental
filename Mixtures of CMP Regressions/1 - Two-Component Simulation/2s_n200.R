...
while(i < B) {
  ...
  if(i%in%seq(50,1000,by=50)) save.image(file=paste("2s_n",n,".RData",sep=""))
  }
}
...
## save .RData
save.image(file=paste("2s_n",n,".RData",sep=""))


## save to txt files

write(paste("Time is", end_time-start_time, attr(end_time-start_time,"units")), 
      file=paste("2s_n",n,"_time",".txt",sep=""))

write.table(y.B, file=paste("2s_n",n,"_samples",".txt",sep=""), sep="  ", row.names=1:B)
write.table(y.E, file=paste("2s_n",n,"_badsamples",".txt",sep=""), sep="  ")

write.table(MLE.cmp, file=paste("2s_n",n,"_MLEs",".txt",sep=""), sep="  ", row.names=1:B)
