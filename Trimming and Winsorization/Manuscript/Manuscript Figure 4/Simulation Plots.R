library(ggplot2)
setwd("/Users/kcheng/Desktop/Simulation Results")
#########################
###### Normal 9095 ######
#########################
load("CoverageNormal9095 .RData")
Normal9095 <- output
P <- 0.90
alpha <- 0.05
...
x.var <- sample.size
df<-data.frame(x.var, Normal9095)
...
x.var <- sample.size
df<-data.frame(x.var, Normal9590)
names(df) <- c("N","Trim" , "Winsorize" , "Trim Tol" , "Winsorize Tol")
...
x.var <- sample.size
df<-data.frame(x.var, Normal9090)
names(df) <- c("N","Trim" , "Winsorize" , "Trim Tol" , "Winsorize Tol")
...
x.var <- sample.size
df<-data.frame(x.var, Normal9595)
names(df) <- c("N","Trim" , "Winsorize" , "Trim Tol" , "Winsorize Tol")
